    ...
    override update(delta: number) {
        ...
        if (!this.assetsLoaded) {
            ...
            game.assets.onLoad(() => {
                ...
                void game.assets.addJson('overworldData', 'res/data/overworld.json');
                void game.assets.addJson('level1Data', 'res/data/level1.json');
                void game.assets.addSound('sword', 'res/sounds/sword.wav');
                void game.assets.addSound('swordShoot', 'res/sounds/LOZ_Sword_Shoot.wav');
                void game.assets.addSound('enemyDie', 'res/sounds/kill.wav');
                void game.assets.addSound('enemyHit', 'res/sounds/LOZ_Hit.wav');
                void game.assets.addSound('stairs', 'res/sounds/LOZ_Stairs.wav');
                void game.assets.addSound('overworldMusic', 'res/sounds/02-overworld.ogg', 5.234);
                void game.assets.addSound('labyrinthMusic', 'res/sounds/04-labyrinth.ogg');
                void game.assets.addSound('linkDies', 'res/sounds/LOZ_Die.wav');
                void game.assets.addSound('text', 'res/sounds/LOZ_Text.wav');
                void game.assets.addSound('linkHurt', 'res/sounds/LOZ_Hurt.wav');
                void game.assets.addSound('shield', 'res/sounds/LOZ_Shield.wav');
                void game.assets.addSound('rupee', 'res/sounds/LOZ_Get_Rupee.wav');
                void game.assets.addSound('heart', 'res/sounds/LOZ_Get_Heart.wav');
                void game.assets.addSound('bombDrop', 'res/sounds/LOZ_Bomb_Drop.wav');
                void game.assets.addSound('bombBlow', 'res/sounds/LOZ_Bomb_Blow.wav');
                void game.assets.addSound('getItem', 'res/sounds/LOZ_Get_Item.wav');
                // Used for both rupees and hearts? TBD? If it doesn't work for hearts, LOZ_Refill_Loop.wav will
                void game.assets.addSound('refilling', 'res/sounds/rupees-changing-22050.wav');
                void game.assets.addSound('rupeesDecreasingEnd', 'res/sounds/rupees-decreasing-end-22050.wav');
                void game.assets.addSound('secret', 'res/sounds/LOZ_Secret.wav');
                game.assets.onLoad(() => {
